// app/products/page.js - About sayfası tarzında SEO düzeltildi
"use client";
...
function ProductsPageComponent() {
  return (
    <>
      {/* Products Sayfası SEO - About Sayfası Tarzında */}
      <Head>
        {/* Meta Tags */}
        <title>
          Ürünlerimiz - Niğde Elma Fidanları | Şahintarım | Premium Kalite
        </title>
        <meta
          name="description"
          content="Şahintarım elma fidanı çeşitlerini keşfedin. Granny Smith, Starking, Gala, Golden Delicious organik elma fidanları. 15+ yıl deneyim, %98 kalite garantisi, Türkiye geneli hızlı teslimat."
        />
        <meta
          name="keywords"
          content="niğde elma fidanı çeşitleri, granny smith elma fidanı, starking elma fidanı, gala elma fidanı, golden delicious fidan, organik elma fidanı, meyve fidanı satış, şahintarım ürünleri, elma ağacı fidanı"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Ürünlerimiz - Niğde Elma Fidanları | Şahintarım | Premium Kalite"
        />
        <meta
          property="og:description"
          content="Şahintarım'ın premium elma fidanı çeşitlerini keşfedin. Organik üretim, kalite garantisi ile."
        />
        ...
        <meta
          ...
          content="Premium kalite elma fidanları. Organik üretim, kalite garantisi."
        />
        ...
        {/* JSON-LD Structured Data - Products Page */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Ürünlerimiz - Şahintarım",
              description: "Şahintarım'ın elma fidanı ürün kataloğu",
              isPartOf: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "ItemList",
              "@id": "https://sahintarim.com/products#catalog",
              name: "Niğde Elma Fidanı Çeşitleri",
              description: "Şahintarım kalitesiyle yetiştirilen elma fidanları",
              numberOfItems: "4",
              itemListElement: [
                {
                  "@type": "ListItem",
                ...
                },
                {
                  ...
                  item: {
                    ...
                    image: ["https://sahintarim.com/images/apples/golden.jpg"],
      ...
      <main>
        {/* ProductsPage Component'i Render Et */}
        <ProductsPage />
      </main>
    </>
  );
