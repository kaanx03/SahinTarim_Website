  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="şahintarım hakkında, tarım işletmesi niğde, elma fidanı üretimi, organik fidan üretimi, aile işletmesi, tarım deneyimi, kalite standartları, sürdürülebilir tarım"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Hakkımızda - Şahintarım Tarım Ürünleri | 15+ Yıl Deneyim"
        />
        <meta
          property="og:description"
          content="2008'den beri Niğde'de faaliyet gösteren aile işletmesi. Misyon, vizyon ve değerlerimizi öğrenin."
        />
        <meta property="og:image" content="/images/company-history.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Şahintarım Şirket Tarihçesi" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sahintarim.com/about" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta
          name="twitter:title"
          content="Hakkımızda - Şahintarım Tarım Ürünleri"
        />
        <meta
          name="twitter:description"
          content="15+ yıl deneyimle Niğde'de faaliyet gösteren aile işletmesi."
        />
        <meta name="twitter:image" content="/images/company-history.jpg" />

        {/* Canonical */}
        <link rel="canonical" href="https://sahintarim.com/about" />

        {/* JSON-LD Structured Data - About Page */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "AboutPage",
              "@id": "https://sahintarim.com/about#webpage",
              url: "https://sahintarim.com/about",
              name: "Hakkımızda - Şahintarım",
              description:
                "Şahintarım'ın hikayesi, misyonu, vizyonu ve değerleri",
              isPartOf: {
              ...
              breadcrumb: {
                ...
                itemListElement: [
                  ...
                  },
                  {
                    ...
                    position: 2,
                    name: "Hakkımızda",
                    item: "https://sahintarim.com/about",
                  },
                ],
              },
            }),
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Organization",
              "@id": "https://sahintarim.com/#organization-detailed",
              ...
              address: {
                "@type": "PostalAddress",
                addressLocality: "Ovacık Kasabası",
                addressRegion: "Niğde",
                addressCountry: "TR",
              },
              contactPoint: [
              ...
              award: [
                ...
                "Organik Üretim Sertifikası",
                "ISTA Üyeliği",
              ],
              knowsAbout: [
                "Elma fidanı üretimi",
                "Organik tarım",
                "Fidan kalite kontrolü",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Dataset",
              name: "Şahintarım İstatistikleri",
              description: "Şahintarım'ın başarı rakamları",
              creator: {
                "@id": "https://sahintarim.com/#organization",
              },
              about: [
            ...
            <div className="sustainability-container">
              ...
              <div className="sustainability-content">
                ...
                <ul>
                  ...
                  <li>
                    <i className="fas fa-solar-panel"></i> Güneş enerji
                    kullanımı
                  </li>
                </ul>
              </div>
